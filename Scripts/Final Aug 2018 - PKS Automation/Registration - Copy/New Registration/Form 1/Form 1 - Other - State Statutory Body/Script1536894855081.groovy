...
WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Business Entity - Other'))

WebUI.delay(1)

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity'))

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity - Other/Sub Business Entity - State Statutory Body'))

WebUI.delay(1)

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity List'))

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity List - Other/Sub Business Entity List - Others - State Statutory Body -Jabatan Ketua Menteri Sar'))

WebUI.delay(1)

not_run: WebUI.setText(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Registration Number'), 
    '123')
...
WebUI.verifyElementPresent(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Acknowledgement Disabled'), 0)

not_run: WebUI.verifyElementNotChecked(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Acknowledgement'), 
    0)

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Industry Name Selection'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Industry Name List - Other/Others - State Statutory Body -Jabatan Ketua Menteri Sab - Perbadanan'))
