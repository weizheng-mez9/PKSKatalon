...
WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity - Other/Sub Business Entity  - Embassy'))

WebUI.delay(1)

not_run: WebUI.delay(1)

not_run: WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity List'))

not_run: WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity List - Other/Sub Business Entity List - Others - Federal Government Agency - Kementerian Pelajaran'))
...
WebUI.check(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Acknowledgement'))

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Industry Name Selection'))

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Industry Name List - Other/Others - Embasy - Seychelles High Commiss'), 
