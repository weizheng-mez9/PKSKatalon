...
WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity - Other/Sub Business Entity  - Federal Statutory Body'))

WebUI.delay(1)

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity List'))

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity List - Other/Sub Business Entity List - Others - Federal Statutory Body - Kementerian pelajaran'))
...
not_run: WebUI.verifyElementNotClickable(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Acknowledgement'), 
...
WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Industry Name List - Other/Others - Federal Statutory Body - Kementerian pelajaran - UNIVERSITI'))
