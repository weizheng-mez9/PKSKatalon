...
WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity - Other/Sub Business Entity - Federal Government Agency'))

WebUI.delay(1)

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity List'))

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity List - Other/Sub Business Entity List - Others - Federal Government Agency - Kementerian Pelajaran'))
