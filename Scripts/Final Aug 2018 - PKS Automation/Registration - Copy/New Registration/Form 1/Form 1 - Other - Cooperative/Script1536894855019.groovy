...
WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity - Other/Sub Business Entity  - Cooperative'))

WebUI.delay(1)

not_run: WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity List'))

not_run: WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity List - Other/Sub Business Entity List - Others - NGO - Registered with Register of Society'))
...
not_run: WebUI.verifyElementPresent(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Acknowledgement Disabled'), 
    0)
