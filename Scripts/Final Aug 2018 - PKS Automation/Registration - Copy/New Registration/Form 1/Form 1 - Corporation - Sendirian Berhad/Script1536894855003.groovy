...
WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Businees Entity - Corporation'))

WebUI.delay(1)

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity'))

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Sub Business Entity - Sendirian Berhad'))

WebUI.delay(1)

WebUI.setText(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Registration Number'), '123')

WebUI.click(findTestObject('Final Object Repo/Registration/Page_Registration - ASSIST/Registred with SSM - Before Feb'))
