...
WebUI.callTestCase(findTestCase('Final Aug 2018 - PKS Automation/Create Employer Acc/Login to Employer Account (Second time)'), [:], FailureHandling.STOP_ON_FAILURE)
...
String abc = WebUI.getAttribute(findTestObject('Final Object Repo/Page_Form 1A - Cessation As Employer/Employer Status'), 'value')
...
if (abc == 'Active') {
    ...
    WebUI.click(findTestObject('Final Object Repo/Page_Form 1A - Cessation As Employer/Change Employer Status to - Dormant'), FailureHandling.STOP_ON_FAILURE)
} else if (abc == 'Cancel') {
    WebUI.click(findTestObject('Final Object Repo/Page_Form 1A - Cessation As Employer/Change Employer Status to'))
    ...
    WebUI.click(findTestObject('Final Object Repo/Page_Form 1A - Cessation As Employer/Change Employer Status to - Cancel'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.doubleClick(findTestObject('Final Object Repo/Page_Form 1A - Cessation As Employer/Calender'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.doubleClick(findTestObject('Final Object Repo/Page_Form 1A - Cessation As Employer/Employment Resign Date'))
...
WebUI.selectOptionByValue(findTestObject('Final Object Repo/Page_Form 1A - Cessation As Employer/Employment Resign Date - Year'), '2030', 
    false)
...
WebUI.sendKeys(findTestObject('Final Object Repo/Page_Form 1A - Cessation As Employer/Uploading File'), 'C:\\Users\\yuki\\Desktop\\Test.png')
