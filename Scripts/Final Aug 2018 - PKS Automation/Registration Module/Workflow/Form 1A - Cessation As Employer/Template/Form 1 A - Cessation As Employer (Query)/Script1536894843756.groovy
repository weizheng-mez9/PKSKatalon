...
WebUI.callTestCase(findTestCase('Final Aug 2018 - PKS Automation/Registration/Search Pending Case For Add Supporting Document (OTC)'), [:], FailureHandling.STOP_ON_FAILURE)
