...
WebUI.click(findTestObject('Final Object Repo/Page_Form 1A - Cessation As Employer/Page_Form 1A - Cessation As Employer (Under enforcement)/Under enforcement'))

WebUI.delay(2)

WebUI.setText(findTestObject('Final Object Repo/Page_Form 1A - Cessation As Employer/Page_Form 1A - Cessation As Employer (Under enforcement)/Under enforcement - remark'), 
    'remark')

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Form 1A - Cessation As Employer/Page_Form 1A - Cessation As Employer (Under enforcement)/Save  Continue in Under enforcement Page'))

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Form 1A - Cessation As Employer/Page_Form 1A - Cessation As Employer (Under enforcement)/Message The case is under enforcement'))
