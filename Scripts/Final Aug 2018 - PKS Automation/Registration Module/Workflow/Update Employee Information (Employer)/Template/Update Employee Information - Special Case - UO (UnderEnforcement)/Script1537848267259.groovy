...
WebUI.click(findTestObject('Final Object Repo/Page_Update Employee Information By Employer/Page_Update Employee Information by Employer (Under enforcement)/Under enforcement'))

WebUI.delay(2)

WebUI.setText(findTestObject('Final Object Repo/Page_Update Employee Information By Employer/Page_Update Employee Information by Employer (Under enforcement)/Under enforcement - Remark'), 
    'Remark')

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Update Employee Information By Employer/Page_Update Employee Information by Employer (Under enforcement)/Save  Continu in Under enforcement Page'))

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Update Employee Information By Employer/Page_Update Employee Information by Employer (Under enforcement)/Under enforceme Message The case is under enforcement'))

WebUI.click(findTestObject('Final Object Repo/Page_Update Employee Information By Employer/Page_Update Employee Information by Employer (Under enforcement)/Under enforcement - OK button'))
