...
WebUI.callTestCase(findTestCase('Final Aug 2018 - PKS Automation/Create Employer Acc/Template/Employer Email Getter'), [:], 
    FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('Final Object Repo/Creating Employer Account/Email'), GlobalVariable.Email)
