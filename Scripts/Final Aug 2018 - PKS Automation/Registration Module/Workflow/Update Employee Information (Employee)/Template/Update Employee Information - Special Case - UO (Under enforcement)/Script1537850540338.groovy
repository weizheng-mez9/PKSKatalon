...
WebUI.click(findTestObject('Final Object Repo/Page_Update Employee Information By Employee/Page_Update Employee Information by Employee (Under enforcement)/Under enforcement'))

WebUI.delay(2)

WebUI.setText(findTestObject('Final Object Repo/Page_Update Employee Information By Employee/Page_Update Employee Information by Employee (Under enforcement)/Under enforcement - remark'), 
    'remark')

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Update Employee Information By Employee/Page_Update Employee Information by Employee (Under enforcement)/Save  Continue in Under enforcement Page'))

WebUI.click(findTestObject('Final Object Repo/Page_Update Employee Information By Employee/Page_Update Employee Information by Employee (Under enforcement)/Message The case is under enforcement'))
