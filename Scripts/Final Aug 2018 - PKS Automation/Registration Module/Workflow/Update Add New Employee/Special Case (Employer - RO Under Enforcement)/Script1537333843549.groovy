...
WebUI.callTestCase(findTestCase('Final Aug 2018 - PKS Automation/Registration Module/Workflow/Update Add New Employee/Template/Employee Adding/Employee Adding Action liability date change - Employer Access'), 
    [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Final Object Repo/Page_Update Add New Employee - ASSIST/Under Enforcement Button at Preview Screen of RO'))

WebUI.delay(4)

WebUI.click(findTestObject('Final Object Repo/Page_Update Add New Employee - ASSIST/Under Enforcement - inner form'))
