...
WebUI.setText(findTestObject('Final Object Repo/Page_Update Add New Employee - ASSIST/NRIC Input'), '830081009219')

WebUI.delay(2)

//'Birthday on the day , 18 y/o on the date\r\n'
WebUI.setText(findTestObject('Final Object Repo/Page_Update Add New Employee - ASSIST/Employee Name Input'), 'Automate002 Employee eligible 1')
...
WebUI.click(findTestObject('Final Object Repo/Page_Update Add New Employee - ASSIST/Select Socso Employment Startdate Year - Emp Update Add New'))
