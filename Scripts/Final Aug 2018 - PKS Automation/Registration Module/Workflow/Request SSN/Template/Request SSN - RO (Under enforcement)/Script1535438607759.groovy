...
not_run: WebUI.sendKeys(findTestObject('Final Object Repo/Page_MyASSIST - ASSIST - Search Pending Case For Add Supporting Document/Reference No'), 'SSN08201800001036')
...
WebUI.click(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/Page_Request SSN - ASSIST - RO/Page_Request SSN - ASSIST (Under enforcement)/Under Enforcement'))

WebUI.delay(2)

WebUI.sendKeys(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/Page_Request SSN - ASSIST - RO/Page_Request SSN - ASSIST (Under enforcement)/Under Endorcement - Remark'), 
    'Remark')

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/Page_Request SSN - ASSIST - RO/Page_Request SSN - ASSIST (Under enforcement)/Save  Continue in Under Enforcement Page'))

WebUI.delay(2)

WebUI.verifyElementVisible(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/Page_Request SSN - ASSIST - RO/Page_Request SSN - ASSIST (Under enforcement)/Message The case is under enforceme'))

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/Page_Request SSN - ASSIST - RO/Page_Request SSN - ASSIST (Under enforcement)/OK'))
