...
try {
    Boolean Checker = WebUI.verifyElementNotPresent(tester, 5)
...
WebUI.setText(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - Current Employer Code'), 'E1102001065V')

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - Current Employer Code - Search'))

WebUI.delay(2)

not_run: WebUI.setText(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - Current Employer Name'), 'perkeso')

not_run: WebUI.setText(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - Current Employer Address1'), 'perkeso1')

not_run: WebUI.setText(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - Current Employer Address2'), 'perkeso2')

not_run: WebUI.setText(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - Current Employer Address3'), 'perkeso3')

not_run: WebUI.click(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - Current Employer State'))

not_run: WebUI.click(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - Current Employer State - Johor 1'))

not_run: WebUI.click(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - Current Employer City'))

not_run: WebUI.setText(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - City - JOH'), 'joh')

not_run: WebUI.delay(2)

not_run: WebUI.click(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - City - Johor Bharu'))

not_run: WebUI.click(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - Current Employer Postcode'))

not_run: WebUI.setText(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - City - JOH'), '810')

not_run: WebUI.delay(2)

not_run: WebUI.click(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/AI - PostCode - 81000'))
...
GlobalVariable.CaseReferenceNo = WebUI.getText(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/Reference Number in Uploading Page - OTC'))

System.out.println(GlobalVariable.CaseReferenceNo)

WebUI.callTestCase(findTestCase('Final Aug 2018 - PKS Automation/Common/Reference Number Setter'), [:], FailureHandling.CONTINUE_ON_FAILURE)
