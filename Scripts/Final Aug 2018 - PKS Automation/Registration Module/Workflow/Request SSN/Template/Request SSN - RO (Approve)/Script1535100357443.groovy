...
not_run: WebUI.sendKeys(findTestObject('Final Object Repo/Page_MyASSIST - ASSIST - Search Pending Case For Add Supporting Document/Reference No'), 'SSN08201800001013')
...
WebUI.click(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/Page_Request SSN - ASSIST - RO/Submit'))

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/Page_Request SSN - ASSIST - RO/Confirm'))

WebUI.delay(2)

WebUI.verifyElementVisible(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/Page_Request SSN - ASSIST - RO/Successfull Message Your application has submitted'))

WebUI.delay(2)

WebUI.verifyElementVisible(findTestObject('Final Object Repo/Page_Request SSN - ASSIST/Page_Request SSN - ASSIST - RO/Letter of approval'))
