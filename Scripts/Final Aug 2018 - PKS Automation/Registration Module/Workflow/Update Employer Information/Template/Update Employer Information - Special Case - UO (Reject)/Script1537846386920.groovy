...
WebUI.click(findTestObject('Final Object Repo/Page_Update Employer Information/Page_Update Employer Information UO (Reject)/Reject'))

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Update Employer Information/Page_Update Employer Information UO (Reject)/Confirm'))

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Update Employer Information/Page_Update Employer Information UO (Reject)/Message This Case has been Rejected'))
