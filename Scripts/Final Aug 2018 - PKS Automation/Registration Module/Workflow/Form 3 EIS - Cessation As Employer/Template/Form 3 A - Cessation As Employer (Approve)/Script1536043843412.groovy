...
WebUI.click(findTestObject('Final Object Repo/Page_Form 3 EIS - Cessation as Employer/Page_Form 3 EIS - Cessation as Employer (Approve)/Approve'))

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Form 3 EIS - Cessation as Employer/Page_Form 3 EIS - Cessation as Employer (Approve)/Confirm'))

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Form 3 EIS - Cessation as Employer/Page_Form 3 EIS - Cessation as Employer (Approve)/Message Your Request    Form 3 EIS'))

WebUI.click(findTestObject('Final Object Repo/Page_Form 3 EIS - Cessation as Employer/Page_Form 3 EIS - Cessation as Employer (Approve)/Letter of successful update'))
