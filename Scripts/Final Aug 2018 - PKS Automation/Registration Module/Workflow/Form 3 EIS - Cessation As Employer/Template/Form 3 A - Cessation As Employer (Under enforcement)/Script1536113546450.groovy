...
WebUI.click(findTestObject('Final Object Repo/Page_Form 3 EIS - Cessation as Employer/Page_Form 3 EIS - Cessation as Employer (Under enforcement)/Underenforcement'))

WebUI.delay(2)

WebUI.setText(findTestObject('Final Object Repo/Page_Form 3 EIS - Cessation as Employer/Page_Form 3 EIS - Cessation as Employer (Under enforcement)/Under enforcement - Remark'), 
    'Remark')

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/Page_Form 3 EIS - Cessation as Employer/Page_Form 3 EIS - Cessation as Employer (Under enforcement)/Save  Continue in Under enforcement'))

WebUI.doubleClick(findTestObject('Final Object Repo/Page_Form 3 EIS - Cessation as Employer/Page_Form 3 EIS - Cessation as Employer (Under enforcement)/Message The case is under enforcement'))
