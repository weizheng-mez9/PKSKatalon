...
WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Third Screen - Upload Supporting Doc- Preview/Preview Submit Button'))

WebUI.delay(2)

WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Third Screen - Upload Supporting Doc- Preview/Preview Submit - Confirm'))
