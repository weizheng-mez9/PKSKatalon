...
WebUI.setText(findTestObject('Final Object Repo/Login Page/Internal User/Email Address'), 'klotc3@gmail.com')
...
WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Sub Business Entity - Other/Sub Business Entity  - Federal Statutory Body'))

WebUI.delay(1)

WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Sub Business Entity List'))

WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Sub Business Entity List - Other/Sub Business Entity List - Others - Federal Statutory Body - Kementerian pelajaran'))
...
WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Industry Name List - Other/Others - Federal Statutory Body - Kementerian pelajaran - UNIVERSITI'))
