...
WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Sub Business Entity - Other/Sub Business Entity  - Cooperative'))

WebUI.delay(1)

not_run: WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Sub Business Entity List'))

not_run: WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Sub Business Entity List - Other/Sub Business Entity List - Others - NGO - Registered with Register of Society'))

not_run: WebUI.delay(1)

WebUI.setText(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Registration Number'), 
    '123')
...
not_run: WebUI.verifyElementPresent(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Acknowledgement Disabled'), 
    0)

WebUI.check(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Acknowledgement'))

WebUI.setText(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Industry name'), 'perkeso')
