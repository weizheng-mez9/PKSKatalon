...
WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Sub Business Entity - Other/Sub Business Entity  - State Government Agency'))

WebUI.delay(1)

WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Sub Business Entity List'))

WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Sub Business Entity List - Other/Sub Business Entity List - Others - State Government Agency - Perlis'))
