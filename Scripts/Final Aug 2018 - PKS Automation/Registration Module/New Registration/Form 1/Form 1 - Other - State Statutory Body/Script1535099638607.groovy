...
WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Sub Business Entity - Other/Sub Business Entity - State Statutory Body'))

WebUI.delay(1)

WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Sub Business Entity List'))

WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Sub Business Entity List - Other/Sub Business Entity List - Others - State Statutory Body -Selangor'))
...
not_run: WebUI.verifyElementNotChecked(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Acknowledgement'), 
    0)
...
WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Form 1/Industry Name List - Other/Others - State Statutory Body -Jabatan Ketua Menteri Sab - Perbadanan'))
