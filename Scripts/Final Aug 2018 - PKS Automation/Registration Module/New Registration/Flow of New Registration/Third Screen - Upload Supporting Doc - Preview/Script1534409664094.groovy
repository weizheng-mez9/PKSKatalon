...
GlobalVariable.CaseReferenceNo = WebUI.getText(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Third Screen - Upload Supporting Doc- Preview/RefNo Acquiring'))
...
WebUI.waitForElementClickable(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Third Screen - Upload Supporting Doc- Preview/Save n Continue in SIP Employee Listing Page'), 
    60)

WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Third Screen - Upload Supporting Doc- Preview/Save n Continue in SIP Employee Listing Page'))
...
WebUI.click(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Third Screen - Upload Supporting Doc- Preview/Select to Upload Borang SIP 2'))
...
WebUI.waitForElementClickable(findTestObject('Final Object Repo/New Registration - Registration Module Pages/Third Screen - Upload Supporting Doc- Preview/Save n Continue in Uploading Supporting Doc Page'), 
    20)
