...
WebUI.setText(findTestObject('Final Object Repo/Login Page/Email TextBox'), 'test@liferay.com')

WebUI.click(findTestObject('Final Object Repo/Login Page/Internal User/Next Button'))

WebUI.delay(2)

WebUI.setText(findTestObject('Final Object Repo/Login Page/Password TextBox'), 'test')
...
WebUI.setText(findTestObject('Final Object Repo/Creating Employer Account/Page_Users and Organizations - ASSIST/Employer name'), GlobalVariable.Email)
...
WebUI.setEncryptedText(findTestObject('Final Object Repo/Creating Employer Account/Page_PERKESO - Users and Organizati/input__125_password1'), 'sYLXs9ykYiyIzLMk/U5GdA==')

WebUI.delay(3)

WebUI.setEncryptedText(findTestObject('Final Object Repo/Creating Employer Account/Page_PERKESO - Users and Organizati/input__125_password2'), 'sYLXs9ykYiyIzLMk/U5GdA==')
