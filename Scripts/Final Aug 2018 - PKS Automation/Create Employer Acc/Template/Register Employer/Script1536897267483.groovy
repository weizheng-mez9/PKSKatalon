...
WebUI.setText(findTestObject('Final Object Repo/Creating Employer Account/Page_Registration - ASSIST (Base)/Employer Name'), 
    'AUTOMATION EMPLOYER')
...
WebUI.setText(findTestObject('Final Object Repo/Creating Employer Account/Page_Registration - ASSIST (Base)/Registration Number'), 
    'AUTOMATE001')

WebUI.delay(2)

WebUI.setText(findTestObject('Final Object Repo/Creating Employer Account/Page_Registration - ASSIST (Base)/Postal Address 1'), 
    'ADDRESS 1')

WebUI.setText(findTestObject('Final Object Repo/Creating Employer Account/Page_Registration - ASSIST (Base)/Postal Address 2'), 
    'ADDRESS 2')
...
WebUI.setText(findTestObject('Final Object Repo/Creating Employer Account/Page_Registration - ASSIST (Base)/City - joh'), 
    'joh')
...
WebUI.setText(findTestObject('Final Object Repo/Creating Employer Account/Page_Registration - ASSIST (Base)/Post Code - 810'), 
    '810')
...
WebUI.setText(findTestObject('Final Object Repo/Creating Employer Account/Page_Registration - ASSIST (Base)/Full Name'), 
    'PERKESO')
...
WebUI.setText(findTestObject('Final Object Repo/Creating Employer Account/Page_Registration - ASSIST (Base)/Identification Number'), 
    IC)

WebUI.delay(2)

WebUI.setText(findTestObject('Final Object Repo/Creating Employer Account/Page_Registration - ASSIST (Base)/Contact Number'), 
    '123456789012')
...
WebUI.callTestCase(findTestCase('Final Aug 2018 - PKS Automation/Create Employer Acc/Template/Employer Email Settler'), 
...
WebUI.setText(findTestObject('Final Object Repo/Creating Employer Account/Page_Registration - ASSIST (Base)/Security Phase'), 
    '123')
...
WebUI.sendKeys(findTestObject('Final Object Repo/Creating Employer Account/Page_Registration - ASSIST (Base)/Uploading File'), 
